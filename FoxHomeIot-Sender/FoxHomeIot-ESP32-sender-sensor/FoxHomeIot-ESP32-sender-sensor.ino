// ----------------------------------------------------------------------------
// firmware name: FoxHomeIoT-ESP32-sender-sensor
// description: send sensor data from sender to bridge using ESP-NOW
// © 2022 Jiří Kučera
...
//#define SLEEP_MODE // deep sleep enable
...
void ReadAndSendDataSensors () {
  Serial.println("Reading sensors and send");
  //Set values to send
  myData.msgType    = DATA;
  myData.id         = BOARD_ID;
